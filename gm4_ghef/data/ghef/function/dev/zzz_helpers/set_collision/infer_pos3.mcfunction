...
execute store result score new ghef_Ay run data get storage ghef:data temp.pos1[1] 10
execute store result score new ghef_Cy run data get storage ghef:data temp.pos2[1] 10

# if y is the same (to the nearest tenth of a block), assume horizontal plane (i.e. floor/ceiling)
execute if score new ghef_Ay = new ghef_Cy run data modify entity @s Pos[0] set from storage ghef:data temp.pos1[0]
execute if score new ghef_Ay = new ghef_Cy run data modify entity @s Pos[1] set from storage ghef:data temp.pos1[1]
execute if score new ghef_Ay = new ghef_Cy run return run data modify entity @s Pos[2] set from storage ghef:data temp.pos2[2]
