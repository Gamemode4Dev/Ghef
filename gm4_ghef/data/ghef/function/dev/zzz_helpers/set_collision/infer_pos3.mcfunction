...
execute store result score Ay ghef_calc run data get storage ghef:data temp.pos1[1] 10
execute store result score Cy ghef_calc run data get storage ghef:data temp.pos2[1] 10

# if y is the same (to the nearest tenth of a block), assume horizontal plane (i.e. floor/ceiling)
execute if score Ay ghef_calc = Cy ghef_calc run data modify entity @s Pos[0] set from storage ghef:data temp.pos1[0]
execute if score Ay ghef_calc = Cy ghef_calc run data modify entity @s Pos[1] set from storage ghef:data temp.pos1[1]
execute if score Ay ghef_calc = Cy ghef_calc run return run data modify entity @s Pos[2] set from storage ghef:data temp.pos2[2]
